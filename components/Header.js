...
function Header() {
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            {/*Left*/}
            <div className="relative flex items-center h-10 cursor-pointer my-auto"> {/*anything styled within div is relative to div Only. if its not relative to div it becomes relative to entire website*/}
